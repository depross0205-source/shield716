...
st.set_page_config(page_title=“Spear and Shield”, page_icon=“shield”, layout=“wide”)
st.title(“矛與盾 數據精確回歸系統”)
...
st.sidebar.header(“資產分配 (1000萬模型)”)
...
up_file = st.sidebar.file_uploader(“上傳 CSV”, type=[‘csv’])
...
st.caption(“v9.30 Data Precision Edition”)
